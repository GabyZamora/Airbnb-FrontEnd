        ...
        <div class="container">
            ...
            <div class="col-lg-10 col-xl-9 mx-auto">
                ...
                <div class="card-body p-4 p-sm-5">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" v-model="email" class="form-control" id="floatingInputEmail" placeholder="name@example.com">
                    ...
                    <div class="d-grid mb-2">
                        <button class="btn btn-lg btn-submit btn-login fw-bold text-uppercase" type="submit">Iniciar Sesión</button>
                    </div>

                    <a class="d-block text-center mt-2 small" href="/register">No tienes una cuenta? Registrate</a>
